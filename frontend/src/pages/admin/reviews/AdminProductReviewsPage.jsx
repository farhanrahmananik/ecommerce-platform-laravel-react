...
function AdminProductReviewsPage() {
  ...
  return (
    <main className="admin-reviews-page admin-list-page">
      <header className="category-list-heading admin-list-header"><div className="admin-list-title-group"><span className="admin-eyebrow">Trust and quality</span><h1>Product reviews</h1><p>Moderate verified customer feedback before it reaches the storefront.</p></div><button className="admin-refresh-button" type="button" onClick={refresh} disabled={loading}><i className={`bi bi-arrow-clockwise ${loading ? 'spin' : ''}`} /></button></header>
